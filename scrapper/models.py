...
class Product(models.Model):
    ...
    amazon_price=models.IntegerField(null=True, default=-1)
    flipkart_price=models.IntegerField(null=True, default=-1)
    brand_name=models.CharField(max_length=20,null=True,default='')
    # date_created=datetimeFeild()
    product_category=models.CharField(max_length=20,null=False,default='')
    ecommerce_company=models.CharField(max_length=20,null=False,default='')
